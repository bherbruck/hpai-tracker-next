...
const PrivacyPolicy: NextPage = (props) => (
  <>
    ...
    <article className="prose m-2 items-center">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to HPAI Tracker.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to HPAI Tracker, accessible from{' '}
            <a
              href="https://hpai-tracker.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://hpai-tracker.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: brennen.herbruck@gmail.com</li>
      </ul>
    </article>
  </>
)
